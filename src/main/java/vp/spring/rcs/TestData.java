...
public class TestData {
	...
	public void init(){
		...
		Student student1 = new Student("pera", "$2a$04$4pqDFh9SxLAg/uSH59JCB.LwIS6QoAjM9qcE7H9e2drFuWhvTnDFi", "Petar", "Petrovic", 123456789, "SF10", 5000);
		SecurityUserAuthority studentAuthority1 = new SecurityUserAuthority(student1, authority3);
		Student student2 = new Student("zoran", "$2a$04$4pqDFh9SxLAg/uSH59JCB.LwIS6QoAjM9qcE7H9e2drFuWhvTnDFi", "Zoran", "Petrovic", 741852963, "SF20", 6258);
		SecurityUserAuthority studentAuthority2 = new SecurityUserAuthority(student2, authority3);
		Student student3 = new Student("goran", "$2a$04$4pqDFh9SxLAg/uSH59JCB.LwIS6QoAjM9qcE7H9e2drFuWhvTnDFi", "Goran", "Petrovic", 852369741, "SF30", 3250);
		SecurityUserAuthority studentAuthority3 = new SecurityUserAuthority(student3, authority3);
		Student student4 = new Student("boban", "$2a$04$4pqDFh9SxLAg/uSH59JCB.LwIS6QoAjM9qcE7H9e2drFuWhvTnDFi", "Boban", "Petrovic", 369852147, "SF40", 4500);
		...
		Teacher teacher2 = new Teacher("dajana", "$2a$04$4pqDFh9SxLAg/uSH59JCB.LwIS6QoAjM9qcE7H9e2drFuWhvTnDFi", "Dajana", "Dajanic", 1212444, "uloga");
		SecurityUserAuthority teacherAuthority2 = new SecurityUserAuthority(teacher2, authority2);
		Teacher teacher3 = new Teacher("jovana", "$2a$04$4pqDFh9SxLAg/uSH59JCB.LwIS6QoAjM9qcE7H9e2drFuWhvTnDFi", "Jovana", "Jovanic", 2341987, "uloga");
		SecurityUserAuthority teacherAuthority3 = new SecurityUserAuthority(teacher3, authority2);
		Teacher teacher4 = new Teacher("ivana", "$2a$04$4pqDFh9SxLAg/uSH59JCB.LwIS6QoAjM9qcE7H9e2drFuWhvTnDFi", "Ivana", "Ivanic", 6542233, "uloga");
